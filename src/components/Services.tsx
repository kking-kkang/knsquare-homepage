...
const services = [
  ...
  },
  {
    ...
    titleKr: "시계열 데이터 분석",
    desc: "수요 예측, 매출 추이 분석, KPI 예측 등 시간 기반 패턴을 분석합니다.",
  ...
  },
  {
    ...
    titleKr: "이미지 데이터 분석",
    desc: "컴퓨터 비전으로 제품 불량 검출, 의료 이미징, 이상 감지를 수행합니다.",
  ...
  },
  {
    ...
    title: "Text Analysis",
    titleKr: "텍스트 데이터 분석",
    desc: "자연어 처리를 통한 감성 분석, 텍스트 분류, 문서 자동 분류를 제공합니다.",
  ...
  },
  {
    ...
    title: "AI Education",
    titleKr: "AI 교육",
    desc: "Orange3/KNIME, 이미지·텍스트 분석, 프롬프트 엔지니어링 교육을 진행합니다.",
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          {services.map((svc) => (
            ...
            >
              <div className="h-full p-6 rounded-xl bg-white border border-border">
